...
HD_PWD='D:/xilinx/projects/example_project/example_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_example_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_example_wrapper.tcl
