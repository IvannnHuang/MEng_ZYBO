...
HD_PWD='D:/xilinx/projects/example_project/example_project.runs/zybo_example_axi_bram_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_example_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_example_axi_bram_ctrl_0_0.tcl
