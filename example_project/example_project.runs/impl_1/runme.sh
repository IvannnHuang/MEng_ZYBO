...
HD_PWD='D:/xilinx/projects/example_project/example_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_example_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zybo_example_wrapper.tcl -notrace
