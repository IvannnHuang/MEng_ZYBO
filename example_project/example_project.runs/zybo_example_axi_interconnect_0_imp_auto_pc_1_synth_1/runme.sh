...
HD_PWD='D:/xilinx/projects/example_project/example_project.runs/zybo_example_axi_interconnect_0_imp_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_example_axi_interconnect_0_imp_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_example_axi_interconnect_0_imp_auto_pc_1.tcl
