...
HD_PWD='c:/users/qijin/documents/meng_zybo/hdmi_driver/zybo-z7-hw/zybo-z7-hw.tmp/lorenz_dda_driver_v1_0_project/lorenz_dda_driver_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lorenz_dda_driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lorenz_dda_driver.tcl
