...
HD_PWD='c:/users/qijin/documents/meng_zybo/hdmi_driver/zybo-z7-hw/zybo-z7-hw.tmp/axi_dda_v1_0_project/axi_dda_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dda_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dda_v1_0.tcl
